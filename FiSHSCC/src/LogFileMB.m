function LogFileMB(inputdata,outputfile,data,ScaleRel,faultname,shearmodulusfrominput,straindropfrominput,M_dM_Lengths_forLOGoutput,out,n_sigma_trunc_magnitudes,yfc)
if ispc==1
...
fprintf(fidout,'%s',char(ScaleRel(i,:)));
fprintf(fidout,'%1s',blanks(1));
